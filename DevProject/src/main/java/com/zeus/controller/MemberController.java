...
//	====================================================================================
	...
	public String registerSpringForm(Member member) {
...
//	// 1. Member 클래스 @NotBlank 생성
//	// 2. BindingResult 검증 하는 결과 값이 들어있다.
//	// 3. @Validated 점검 하는 대상 알려준다
//	// 4. result.hasErrors() == true 에러가 있는지 확인
